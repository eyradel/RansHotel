<?php
/**
 * Simple Email System for RansHotel
...
class SimpleEmailSystem {
    ...
    private function sendEmail($to, $subject, $message) {
        try {
            ...
            // Try to send via a web service (this is a placeholder - you can replace with actual service)
            $result = $this->sendViaWebService($emailData);
            ...
            if ($result) {
                return [
                    ...
                    'to' => $to,
                    'subject' => $subject,
                    'message' => 'Email sent successfully via web service'
                ];
            } else {
    ...
    /**
     * Send via web service (placeholder - replace with actual service)
     */
    private function sendViaWebService($emailData) {
